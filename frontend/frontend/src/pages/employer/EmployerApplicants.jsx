            ...
            >
              {jobs.map((job) => (
                <option key={job._id} value={job._id}>
                  {job.title} • {job.applicantCount || 0} applicants • Status: {(job.jobStatus || job.status || "active").toUpperCase()}
                </option>
              ))}
            </select>
          </div>
              ...
              {displayedApplicants.map((applicant) => (
                <div key={applicant._id} className="emp-applicant-card">
                  ...
                  <div className="emp-applicant-right">
                    ...
                    <div className={`emp-score-circle ${getScoreClass(applicant.similarityScore)}`}>
