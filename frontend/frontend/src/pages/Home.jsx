    ...
    <div className="landing-page">
      ...
      <nav className="navbar">
        ...
        <div className="nav-actions">
          <button className="nav-login" style={{ marginRight: '10px' }} onClick={() => navigate("/user/login")}>
            Job Seeker Login
          </button>
          <button className="nav-login" style={{ marginRight: '10px' }} onClick={() => navigate("/employer/login")}>
            Employer Login
          </button>
          <button className="nav-signup" onClick={() => navigate("/admin/login")}>
            Super Admin
          </button>
        </div>
      </nav>
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <button className="btn-secondary" style={{ background: 'rgba(139, 92, 246, 0.15)', borderColor: '#8b5cf6', color: '#8b5cf6' }} onClick={() => navigate("/admin/login")}>
              🛡️ Super Admin Panel
            </button>
          </div>
        </div>
