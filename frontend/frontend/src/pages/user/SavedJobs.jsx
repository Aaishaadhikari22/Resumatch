            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "20px", flexWrap: "wrap", marginTop: "15px" }}>
                  ...
                  {job.salary && <span style={{ color: "#64748b", fontSize: "13px", display: "flex", alignItems: "center", gap: "5px" }}>💰 {typeof job.salary === 'object' ? `${job.salary.min}-${job.salary.max} ${job.salary.currency}` : job.salary}</span>}
