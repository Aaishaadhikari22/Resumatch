...
export default function EmployerSettings() {
  ...
  const [editMinExperienceYears, setEditMinExperienceYears] = useState(0);
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Profile data loaded but not stored in state
  ...
  const handleSaveProfile = async () => {
    try {
      setLoading(true);
      await API.put("/employer/profile", { name: contactName, companyName, companyDescription, logo, industryType, employeeCount, registrationNumber });
      showSave("Company profile updated ✅");
      // Employer data updated
      fetchProfile();
    } catch (err) {
  ...
  const handleEditJob = (job) => {
    ...
    setEditExperienceLevel(job.experienceLevel || "Mid-level");
    setEditMinExperienceYears(job.minExperienceYears || 0);
    setEditEducationLevel(job.educationLevel || "Any");
  ...
  const handleSaveEditJob = async () => {
    try {
      ...
      await API.put(`/employer/jobs/${editingJob}`, {
        ...
        minExperienceYears: editMinExperienceYears,
            ...
            <>
              ...
              <div className="settings-row">
                ...
                <div className="settings-field">
                  ...
                  <input type="text" value={contactName} onChange={(e) => setContactName(e.target.value)} placeholder="Enter contact person's name" />
                </div>
              </div>
              ...
              <div className="settings-row">
                <div className="settings-field">
                  ...
                  <input type="text" value={industryType} onChange={(e) => setIndustryType(e.target.value)} placeholder="e.g. Technology, Finance" />
                </div>
                <div className="settings-field">
                        ...
                        <div>
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "12px" }}>
                            <div className="settings-field">
                                ...
                                <select value={editExperienceLevel} onChange={(e) => setEditExperienceLevel(e.target.value)} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #cbd5e1", width: "100%" }}>
                            ...
                            <div className="settings-field">
                                ...
                                <input type="number" min="0" value={editMinExperienceYears} onChange={(e) => setEditMinExperienceYears(Number(e.target.value))} />
                            </div>
                          </div>
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", marginBottom: "12px" }}>
                            <div className="settings-field">
                                ...
                                <select value={editEducationLevel} onChange={(e) => setEditEducationLevel(e.target.value)} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #cbd5e1", width: "100%" }}>
                            ...
                            <div className="settings-field">
                                ...
                                <select value={editEmploymentType} onChange={(e) => setEditEmploymentType(e.target.value)} style={{ padding: "10px", borderRadius: "8px", border: "1px solid #cbd5e1", width: "100%" }}>
